        ...
        <>
            ...
            <main>
                <div className="container mx-auto max-w-3xl mt-10 px-4">
                    <h1 className="font-serif text-3xl sm:text-5xl font-semibold">About Me</h1>
                    <div className="mt-4">
                        <BioLinks />
                    </div>
                    <section >
                    ...
                    <section >
                        <h2 className="text-xl sm:text-3xl font-semibold mt-6">What I'm Doing Now</h2>
                    ...
                    <section >
                        <h2 className="text-xl sm:text-3xl font-semibold mt-6">What I Have Done</h2>
                    ...
                    <section >
                        <h2 className="text-xl sm:text-3xl font-semibold mt-6">Other Things I Enjoy</h2>
                        <p className="sm:text-lg mt-4">
